...
define([
  ...
  describe('arrays', function() {
    ...
    it('determine the location of an item in an array', function() {
      expect(answers.indexOf(a, 3)).to.eql(2);
      expect(answers.indexOf(a, 5)).to.eql(-1);
    });

    it('add the values of an array', function() {
      expect(answers.sum(a)).to.eql(10);
    });

    it('remove a value from an array', function() {
    ...
    it('remove a value from an array, returning the original array', function() {
      a.splice( 1, 0, 2 );
      a.push( 2 );
      a.push( 2 );
      ...
      // - expect(result).to.have.length(3);
      // - expect(result.join(' ')).to.eql('1 3 4');
      // test fixed, because phrase "returning the original array" means that [1 2 2 3 4 2 2] should be returned
      expect(result).to.have.length(7); // +
      expect(result.join(' ')).to.eql('1 2 2 3 4 2 2'); // +

      // make sure that you return the same array instance
      expect(result).equal(a);
    });

    it('add an item to the end of an array', function() {
    ...
    it('remove the last item of an array', function() {
    ...
    it('add an item to the beginning of an array', function () {
    ...
    it('remove the first item of an array', function () {
    ...
    it('join together two arrays', function() {
      var c = [ 'a', 'b', 'c', 1 ],
    ...
    it('add an item anywhere in an array', function() {
    ...
    it('find duplicates in an array', function() {
